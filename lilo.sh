...
install_accessories_apps(){
  ...
  do
    ...
    echo " 5) $(menu_item "keepass")"
    echo " 6) $(menu_item "pamac-aur" "Pamac") $AUR"
    echo " 7) $(menu_item "shutter hotshots" "$([[ ${KDE} -eq 1 ]] && echo "Hotshots" || echo "Shutter";)")"
    echo " 8) $(menu_item "synapse")"
    echo " 9) $(menu_item "terminator")"
...
install_development_apps(){
  ...
  do
    ...
    echo " 5) $(menu_item "sublime-text2" "Sublime Text 2") $AUR"
    echo " 6) $(menu_item "sublime-text-dev" "Sublime Text 3") $AUR"
    echo " 7) $(menu_item "android-studio" "Android Studio") $AUR"
    echo " 8) $(menu_item "jetbrains-toolbox" "Jetbrains Toolbox") $AUR"
    echo " 9) $(menu_item "intellij-idea-community-edition" "IntelliJ IDEA Community Edition")"
    echo "10) $(menu_item "intellij-idea-ultimate-edition" "IntelliJ IDEA Ultimate Edition") $AUR"
    echo "11) $(menu_item "monodevelop")"
    echo "12) $(menu_item "qtcreator")"
    echo "13) $(menu_item "mysql-workbench" "MySQL Workbench") $AUR"
    echo "14) $(menu_item "jdk8-openjdk" "OpenJDK 8")"
    echo "15) $(menu_item "jdk9-openjdk" "OpenJDK 9")"
    echo "16) $(menu_item "jdk10-openjdk" "OpenJDK 10")"
    echo "17) $(menu_item "jdk" "Oracle JDK") $AUR"
    echo "18) $(menu_item "nodejs")"
    echo "19) $(menu_item "visual-studio-code-bin" "Visual Studio Code") $AUR"
    echo "20) $(menu_item "gitg")"
    echo "21) $(menu_item "kdiff3")"
    echo "22) $(menu_item "regexxer")"
      ...
      case "$OPT" in
        1)
          ...
          do
            ...
            echo " 5) $(menu_item "parole")"
            echo " 6) $(menu_item "plex-media-server" "Plex") $AUR"
